...
|:------------|:-------------------|:------:|:-----------------------------------|
| 🐧 Linux    | amd64, arm64, arm  | ✅     | All features                       |
| 🍎 macOS    | amd64, arm64       | ✅     | All features                       |
| 🪟 Windows  | amd64, arm64       | ✅     | CPU Queue Length instead of load   |
| 😈 FreeBSD  | amd64              | ✅     | All features                       |
...
│ 5678     www          12.1   1.8    Sleeping  nginx: worker         │
└─────────────────────────────────────────────────────────────────────┘
 Konrul | F1:Help F8:Sort F9:Kill F10:Quit | /:Search t:Tree d:Docker
```
